...
This managed section connects **CLAUDE.md** to Mission Directives **2.0.0** at `.`. Preserve instructions outside this block. Regenerate this block with `python tools/sync_agent_guidance.py --project-root .` instead of editing it manually.
