...
def test_mastery_manual_is_deep_and_linked():
 p=ROOT/'docs/MD_MASTERY_MANUAL.md'; text=p.read_text(encoding='utf-8'); assert len(text.splitlines())>=700
 for phrase in ['Template System','Daily TOML Logging','Cross-Platform Tooling','Exact Twin','Prompt Anatomy','Scenario Runtime','Skill Governance','Evaluation and Proof','Troubleshooting']:
