...
Thirty failed runs were recorded, all in `Validate Mission Directives`. The documentation workflow had eight successful runs and no failures. The publishing workflow had not yet run at this snapshot.
