...
function promptsPage(catalog) {
  ...
  return shell({ title: 'Prompts', description: 'Every Mission Directives prompt explained from the canonical catalog.', active: 'prompts', section: 'Prompts', content });
}
...
function scenariosPage(scenarios) {
  ...
  return shell({ title: 'Scenarios', description: 'Mission Directives atomic and composite scenarios explained.', active: 'scenarios', section: 'Scenarios', content });
}
...
function pairsPage(catalog) {
  ...
  return shell({ title: 'Pairs', description: 'Mission Directives planning and execution prompt pairs explained.', active: 'pairs', section: 'Pairs', content });
}
