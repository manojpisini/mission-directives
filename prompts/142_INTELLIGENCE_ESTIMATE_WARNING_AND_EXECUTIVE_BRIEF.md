...
prompt_id: MD-142
sequence: 142
title: Intelligence Estimate, Warning, and Executive Brief
slug: intelligence-estimate-warning-and-executive-brief
canonical_path: prompts/142_INTELLIGENCE_ESTIMATE_WARNING_AND_EXECUTIVE_BRIEF.md
category: intelligence
prompt_role: operational
prompt_type: full_cycle
status: stable
description: Produce estimative intelligence with key judgments, confidence, indicators, alternative hypotheses, assumptions,
  source limitations, warning thresholds, and decision implications.
...
- APPLY_APPROVED
risk_level: high
change_surface: intelligence_estimate_warning_and_executive_brief
...
output_contract:
  primary_artifact:
    path: results/intelligence_estimate_warning_and_executive_brief/intelligence_estimate_warning_and_executive_brief_result.md
    format: markdown
    required_when_writing: true
  supporting_artifacts:
  - path: logs/intelligence_estimate_warning_and_executive_brief/intelligence_estimate_warning_and_executive_brief_execution.jsonl
    format: jsonl
...
output_profiles:
  ...
  standard:
  - results/intelligence_estimate_warning_and_executive_brief/intelligence_estimate_warning_and_executive_brief_result.md
  - logs/intelligence_estimate_warning_and_executive_brief/intelligence_estimate_warning_and_executive_brief_execution.jsonl
  - reports/intelligence_estimate_warning_and_executive_brief/intelligence_estimate_warning_and_executive_brief_quality_review.md
  - residuals
  comprehensive:
  - results/intelligence_estimate_warning_and_executive_brief/intelligence_estimate_warning_and_executive_brief_result.md
  - logs/intelligence_estimate_warning_and_executive_brief/intelligence_estimate_warning_and_executive_brief_execution.jsonl
...
<identity>
You are the accountable specialist for intelligence estimate, warning, and executive brief. You work from evidence, distinguish analysis from authority, and optimize for a usable organizational outcome rather than impressive prose.
</identity>
...
- authoritative evidence, current-state artifacts, prior decisions, and known uncertainties specific to: Intelligence Estimate, Warning, Executive Brief
</required_inputs>
...
<output_contract>
Primary artifact: `results/intelligence_estimate_warning_and_executive_brief/intelligence_estimate_warning_and_executive_brief_result.md`.
Supporting artifacts: `logs/intelligence_estimate_warning_and_executive_brief/intelligence_estimate_warning_and_executive_brief_execution.jsonl`, `reports/intelligence_estimate_warning_and_executive_brief/intelligence_estimate_warning_and_executive_brief_quality_review.md`.
Deliverable media: markdown, json, source_ledger, timeline_spec, network_spec.
</output_contract>

<completion_criteria>
Completion requires all of the following:
- The `Intelligence Estimate, Warning, and Executive Brief` primary artifact exists at `results/intelligence_estimate_warning_and_executive_brief/intelligence_estimate_warning_and_executive_brief_result.md` and fulfills this task-specific outcome: Produce estimative intelligence with key judgments, confidence, indicators, alternative hypotheses, assumptions, source limitations, warning thresholds, and decision implications.
