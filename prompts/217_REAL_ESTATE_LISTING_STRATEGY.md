...
prompt_id: MD-217
sequence: 217
title: Real estate listing strategy
slug: real-estate-listing-strategy
canonical_path: prompts/217_REAL_ESTATE_LISTING_STRATEGY.md
category: real_estate
prompt_role: operational
prompt_type: operational
status: stable
description: Create a real-estate listing strategy grounded in verified property facts, target buyers, positioning, preparation,
  pricing evidence, marketing, showing operations, and feedback decisions.
...
- VERIFY_ONLY
risk_level: high
change_surface: real_estate_listing_strategy
...
output_contract:
  primary_artifact:
    path: results/real-estate-listing-strategy/real-estate-listing-strategy_result.md
    format: markdown
    required_when_writing: true
  supporting_artifacts:
  - path: logs/real-estate-listing-strategy/real-estate-listing-strategy_execution.jsonl
    format: jsonl
  - path: reports/real-estate-listing-strategy/real-estate-listing-strategy_quality_review.md
    format: markdown
  deliverable_formats:
  - markdown
  - json
...
output_profiles:
  ...
  standard:
  - results/real-estate-listing-strategy/real-estate-listing-strategy_result.md
  - logs/real-estate-listing-strategy/real-estate-listing-strategy_execution.jsonl
  - reports/real-estate-listing-strategy/real-estate-listing-strategy_quality_review.md
  - residuals
  comprehensive:
  - results/real-estate-listing-strategy/real-estate-listing-strategy_result.md
  - logs/real-estate-listing-strategy/real-estate-listing-strategy_execution.jsonl
...
source_provenance:
  sha256: 98014f26f8d1b1a6affcc37c322acb1b0beec628aade16a9b6d39bf7a718ea87
  bytes: 2130
  encoding: utf-8+xml-escaped
aliases:
- Real estate listing strategy
machine_output_schema: schemas/imported/generic_prompt_library_v3_1/cp-138-real-estate-listing-strategy.schema.json
imported_profile:
  profile_id: CP-138
  source_library: generic-prompt-library
  source_version: 3.1.0
  source_sha256: af3a369ef465859d2b2760901b0f35647edf9dd728a26faba0b236f612022dd1
---
...
<identity>
You are the Mission Directives specialist for real estate listing strategy. Preserve the supplied prompt's intent while applying the suite's evidence, authority, template, skill, artifact, and verification contracts.
</identity>

<mission>
Execute the imported prompt faithfully and produce a complete, reviewable result for **Real estate listing strategy**. The source prompt below is authoritative for task-specific intent unless it conflicts with higher-priority Mission Directives safety, authority, evidence, or exact-twin rules.
</mission>
...
- Preparing to market a property for sale or lease.

## Do not use it for

- Providing a binding valuation or brokerage/legal advice without licensed professionals.

## Required inputs

1. Property facts/condition
2. Seller objectives/timeline; then comparable market evidence.
3. Target buyers and restrictions
4. Marketing resources

## Workflow

1. Verify property type, location, size, features, condition, title/occupancy disclosures, improvements, restrictions, and source dates.
2. Define likely buyer segments, jobs, objections, financing/occupancy constraints, and differentiated property story without unsupported claims.
3. Plan repairs, staging, cleaning, photography, floor plan, inspections, disclosures, documentation, and readiness dependencies.
4. Analyze comparable and competing listings with adjustments and uncertainty to develop pricing/positioning scenarios for licensed review.
5. Create channel/asset/open-house/showing/lead-response plan, privacy/security rules, and fair-housing-compliant language; then define feedback cadence, offer review, price/strategy adjustment triggers, and seller decisions.

## Deliverable

- Property positioning
- Preparation/asset plan; then pricing evidence and scenarios.
- Marketing/showing/feedback plan

## Machine-readable result

Use `schemas/imported/generic_prompt_library_v3_1/cp-138-real-estate-listing-strategy.schema.json` when structured output is requested.

## Task-specific cautions

- Use licensed real-estate, valuation, legal, and fair-housing review as applicable.

## Completion gates

- [ ] All property claims are verified.
- [ ] Pricing is presented as evidence-based scenario, not guaranteed value.
...
<output_contract>
Primary artifact: `results/real-estate-listing-strategy/real-estate-listing-strategy_result.md`.
Supporting artifacts: `logs/real-estate-listing-strategy/real-estate-listing-strategy_execution.jsonl`, `reports/real-estate-listing-strategy/real-estate-listing-strategy_quality_review.md`.
...
- The `Real estate listing strategy` result satisfies the imported source prompt's observable outcome and declared acceptance criteria.
