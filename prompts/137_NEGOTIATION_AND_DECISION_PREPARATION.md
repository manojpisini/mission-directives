...
prompt_id: MD-137
sequence: 137
title: Negotiation and Decision Preparation
slug: negotiation-and-decision-preparation
canonical_path: prompts/137_NEGOTIATION_AND_DECISION_PREPARATION.md
category: strategy
prompt_role: investigative
prompt_type: analysis
status: stable
description: Prepare principled negotiations through interests, constraints, alternatives, objective criteria, issue packages,
  concession boundaries, questions, scenarios, and decision checkpoints without manipulation.
...
- VERIFY_ONLY
risk_level: medium
change_surface: negotiation_and_decision_preparation
...
output_contract:
  primary_artifact:
    path: results/negotiation_and_decision_preparation/negotiation_and_decision_preparation_result.md
    format: markdown
    required_when_writing: true
  supporting_artifacts:
  - path: logs/negotiation_and_decision_preparation/negotiation_and_decision_preparation_execution.jsonl
    format: jsonl
...
output_profiles:
  ...
  standard:
  - results/negotiation_and_decision_preparation/negotiation_and_decision_preparation_result.md
  - logs/negotiation_and_decision_preparation/negotiation_and_decision_preparation_execution.jsonl
  - reports/negotiation_and_decision_preparation/negotiation_and_decision_preparation_quality_review.md
  - residuals
  comprehensive:
  - results/negotiation_and_decision_preparation/negotiation_and_decision_preparation_result.md
  - logs/negotiation_and_decision_preparation/negotiation_and_decision_preparation_execution.jsonl
...
<identity>
You are the accountable specialist for negotiation and decision preparation. You work from evidence, distinguish analysis from authority, and optimize for a usable organizational outcome rather than impressive prose.
</identity>
...
- authoritative evidence, current-state artifacts, prior decisions, and known uncertainties specific to: Negotiation, Decision Preparation
</required_inputs>
...
<output_contract>
Primary artifact: `results/negotiation_and_decision_preparation/negotiation_and_decision_preparation_result.md`.
Supporting artifacts: `logs/negotiation_and_decision_preparation/negotiation_and_decision_preparation_execution.jsonl`, `reports/negotiation_and_decision_preparation/negotiation_and_decision_preparation_quality_review.md`.
Deliverable media: markdown, json.
</output_contract>

<completion_criteria>
Completion requires all of the following:
- The `Negotiation and Decision Preparation` primary artifact exists at `results/negotiation_and_decision_preparation/negotiation_and_decision_preparation_result.md` and fulfills this task-specific outcome: Prepare principled negotiations through interests, constraints, alternatives, objective criteria, issue packages, concession boundaries, questions, scenarios, and decision checkpoints without manipulation.
