...
prompt_id: MD-188
sequence: 188
title: LLM Application, RAG, Memory, and Tool Architecture
slug: llm-application-rag-memory-and-tool-architecture
canonical_path: prompts/188_LLM_APPLICATION_RAG_MEMORY_AND_TOOL_ARCHITECTURE.md
category: llm_engineering
prompt_role: investigative
prompt_type: analysis
status: stable
description: Design language-model applications with retrieval, memory, tools, permissions, grounding, evaluation, observability,
  cost, failure handling, and human control.
...
- VERIFY_ONLY
risk_level: high
change_surface: llm_application_rag_memory_and_tool_architecture
...
output_contract:
  primary_artifact:
    path: results/llm_application_rag_memory_and_tool_architecture/llm_application_rag_memory_and_tool_architecture_result.md
    format: markdown
    required_when_writing: true
  supporting_artifacts:
  - path: logs/llm_application_rag_memory_and_tool_architecture/llm_application_rag_memory_and_tool_architecture_execution.jsonl
    format: jsonl
...
output_profiles:
  ...
  standard:
  - results/llm_application_rag_memory_and_tool_architecture/llm_application_rag_memory_and_tool_architecture_result.md
  - logs/llm_application_rag_memory_and_tool_architecture/llm_application_rag_memory_and_tool_architecture_execution.jsonl
  - reports/llm_application_rag_memory_and_tool_architecture/llm_application_rag_memory_and_tool_architecture_quality_review.md
  - residuals
  comprehensive:
  - results/llm_application_rag_memory_and_tool_architecture/llm_application_rag_memory_and_tool_architecture_result.md
  - logs/llm_application_rag_memory_and_tool_architecture/llm_application_rag_memory_and_tool_architecture_execution.jsonl
...
<identity>
You are the accountable specialist for llm application, rag, memory, and tool architecture. You work from evidence, distinguish analysis from authority, and optimize for a usable organizational outcome rather than impressive prose.
</identity>
...
- authoritative evidence, current-state artifacts, prior decisions, and known uncertainties specific to: LLM Application, RAG, Memory, Tool Architecture
</required_inputs>
...
<output_contract>
Primary artifact: `results/llm_application_rag_memory_and_tool_architecture/llm_application_rag_memory_and_tool_architecture_result.md`.
Supporting artifacts: `logs/llm_application_rag_memory_and_tool_architecture/llm_application_rag_memory_and_tool_architecture_execution.jsonl`, `reports/llm_application_rag_memory_and_tool_architecture/llm_application_rag_memory_and_tool_architecture_quality_review.md`.
Deliverable media: markdown, json, architecture_spec, evaluation_plan.
</output_contract>

<completion_criteria>
Completion requires all of the following:
- The `LLM Application, RAG, Memory, and Tool Architecture` primary artifact exists at `results/llm_application_rag_memory_and_tool_architecture/llm_application_rag_memory_and_tool_architecture_result.md` and fulfills this task-specific outcome: Design language-model applications with retrieval, memory, tools, permissions, grounding, evaluation, observability, cost, failure handling, and human control.
