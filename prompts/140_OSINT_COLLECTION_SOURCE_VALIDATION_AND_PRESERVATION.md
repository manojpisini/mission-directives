...
prompt_id: MD-140
sequence: 140
title: OSINT Collection, Source Validation, and Preservation
slug: osint-collection-source-validation-and-preservation
canonical_path: prompts/140_OSINT_COLLECTION_SOURCE_VALIDATION_AND_PRESERVATION.md
category: osint
prompt_role: operational
prompt_type: full_cycle
status: stable
description: Collect authorized public information with provenance, timestamps, source validation, contradiction tracking,
  chain of custody, privacy minimization, and reproducible preservation.
...
- APPLY_APPROVED
risk_level: high
change_surface: osint_collection_source_validation_and_preservation
...
output_contract:
  primary_artifact:
    path: results/osint_collection_source_validation_and_preservation/osint_collection_source_validation_and_preservation_result.md
    format: markdown
    required_when_writing: true
  supporting_artifacts:
  - path: logs/osint_collection_source_validation_and_preservation/osint_collection_source_validation_and_preservation_execution.jsonl
    format: jsonl
...
output_profiles:
  ...
  standard:
  - results/osint_collection_source_validation_and_preservation/osint_collection_source_validation_and_preservation_result.md
  - logs/osint_collection_source_validation_and_preservation/osint_collection_source_validation_and_preservation_execution.jsonl
  - reports/osint_collection_source_validation_and_preservation/osint_collection_source_validation_and_preservation_quality_review.md
  - residuals
  comprehensive:
  - results/osint_collection_source_validation_and_preservation/osint_collection_source_validation_and_preservation_result.md
  - logs/osint_collection_source_validation_and_preservation/osint_collection_source_validation_and_preservation_execution.jsonl
...
<identity>
You are the accountable specialist for osint collection, source validation, and preservation. You work from evidence, distinguish analysis from authority, and optimize for a usable organizational outcome rather than impressive prose.
</identity>
...
- authoritative evidence, current-state artifacts, prior decisions, and known uncertainties specific to: OSINT Collection, Source Validation, Preservation
</required_inputs>
...
<output_contract>
Primary artifact: `results/osint_collection_source_validation_and_preservation/osint_collection_source_validation_and_preservation_result.md`.
Supporting artifacts: `logs/osint_collection_source_validation_and_preservation/osint_collection_source_validation_and_preservation_execution.jsonl`, `reports/osint_collection_source_validation_and_preservation/osint_collection_source_validation_and_preservation_quality_review.md`.
Deliverable media: markdown, json, source_ledger, timeline_spec, network_spec.
</output_contract>

<completion_criteria>
Completion requires all of the following:
- The `OSINT Collection, Source Validation, and Preservation` primary artifact exists at `results/osint_collection_source_validation_and_preservation/osint_collection_source_validation_and_preservation_result.md` and fulfills this task-specific outcome: Collect authorized public information with provenance, timestamps, source validation, contradiction tracking, chain of custody, privacy minimization, and reproducible preservation.
