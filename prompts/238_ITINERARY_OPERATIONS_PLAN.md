...
prompt_id: MD-238
sequence: 238
title: Itinerary operations plan
slug: itinerary-operations-plan
canonical_path: prompts/238_ITINERARY_OPERATIONS_PLAN.md
category: hospitality_and_travel
prompt_role: operational
prompt_type: operational
status: stable
description: Turn a travel itinerary into an executable operations plan with verified bookings, transfers, buffers, documents,
  accessibility, time zones, contacts, disruptions, and communication.
...
- VERIFY_ONLY
risk_level: high
change_surface: itinerary_operations_plan
...
output_contract:
  primary_artifact:
    path: results/itinerary-operations-plan/itinerary-operations-plan_result.md
    format: markdown
    required_when_writing: true
  supporting_artifacts:
  - path: logs/itinerary-operations-plan/itinerary-operations-plan_execution.jsonl
    format: jsonl
  - path: reports/itinerary-operations-plan/itinerary-operations-plan_quality_review.md
    format: markdown
  deliverable_formats:
  - markdown
  - json
suite_version: 2.0.0
capability_id: md.hospitality_and_travel.itinerary-operations-plan
prompt_slug: itinerary-operations-plan
...
output_profiles:
  ...
  standard:
  - results/itinerary-operations-plan/itinerary-operations-plan_result.md
  - logs/itinerary-operations-plan/itinerary-operations-plan_execution.jsonl
  - reports/itinerary-operations-plan/itinerary-operations-plan_quality_review.md
  - residuals
  comprehensive:
  - results/itinerary-operations-plan/itinerary-operations-plan_result.md
  - logs/itinerary-operations-plan/itinerary-operations-plan_execution.jsonl
...
source_provenance:
  sha256: 74dfa7e937d53b5eb720664907a755524f146895375ef29da4c60c8a3c3705db
  bytes: 2040
  encoding: utf-8+xml-escaped
aliases:
- Itinerary operations plan
machine_output_schema: schemas/imported/generic_prompt_library_v3_1/cp-159-itinerary-operations-plan.schema.json
imported_profile:
  profile_id: CP-159
  source_library: generic-prompt-library
  source_version: 3.1.0
  source_sha256: 12c7af38f668f3358b88be6a9457818067586fc8eeef4d5eddc0dde9230b5839
---
...
<identity>
You are the Mission Directives specialist for itinerary operations plan. Preserve the supplied prompt's intent while applying the suite's evidence, authority, template, skill, artifact, and verification contracts.
</identity>

<mission>
Execute the imported prompt faithfully and produce a complete, reviewable result for **Itinerary operations plan**. The source prompt below is authoritative for task-specific intent unless it conflicts with higher-priority Mission Directives safety, authority, evidence, or exact-twin rules.
</mission>
...
- Coordinating individual/group/business travel.

## Do not use it for

- Guaranteeing travel conditions or ignoring live advisories.

## Required inputs

1. Traveler details/preferences
2. Bookings and confirmations
3. Locations/dates/timezones; then documents/visa/health needs.
4. Budget and disruption policy

## Workflow

1. Verify traveler names as documents, contacts, preferences, accessibility/medical accommodations, loyalty, emergency contact, and data minimization.
2. Normalize all segments by local time/timezone, terminals/addresses, confirmation, status, baggage, check-in, cancellation, and contact.
3. Validate transfer feasibility with immigration/security/baggage, traffic, mobility, venue access, buffer, and alternative routes; then track passport/visa/entry/health/insurance requirements through authoritative current sources and assign traveler/professional confirmation.
4. Prepare daily itinerary with transport, lodging, meetings, meals, contacts, maps, costs, documents, and communication checkpoints.
5. Create disruption alternatives, rebooking authority, emergency process, offline copies, and confirmation cadence.

## Deliverable

- Verified itinerary
- Transfer/document/readiness checks; then daily operational plan.
- Disruption and communication plan

## Machine-readable result

Use `schemas/imported/generic_prompt_library_v3_1/cp-159-itinerary-operations-plan.schema.json` when structured output is requested.

## Completion gates

- [ ] Names, dates, timezones, and confirmations reconcile.
- [ ] Critical transfers and documents have verified buffers/status.
...
<output_contract>
Primary artifact: `results/itinerary-operations-plan/itinerary-operations-plan_result.md`.
Supporting artifacts: `logs/itinerary-operations-plan/itinerary-operations-plan_execution.jsonl`, `reports/itinerary-operations-plan/itinerary-operations-plan_quality_review.md`.
...
- The `Itinerary operations plan` result satisfies the imported source prompt's observable outcome and declared acceptance criteria.
