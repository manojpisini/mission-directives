...
prompt_id: MD-151
sequence: 151
title: Product Discovery, Strategy, Roadmap, and Lifecycle
slug: product-discovery-strategy-roadmap-and-lifecycle
canonical_path: prompts/151_PRODUCT_DISCOVERY_STRATEGY_ROADMAP_AND_LIFECYCLE.md
category: product
prompt_role: investigative
prompt_type: analysis
status: stable
description: Connect user evidence, market context, business strategy, product outcomes, options, sequencing, lifecycle decisions,
...
- VERIFY_ONLY
risk_level: medium
change_surface: product_discovery_strategy_roadmap_and_lifecycle
...
output_contract:
  primary_artifact:
    path: results/product_discovery_strategy_roadmap_and_lifecycle/product_discovery_strategy_roadmap_and_lifecycle_result.md
    format: markdown
    required_when_writing: true
  supporting_artifacts:
  - path: logs/product_discovery_strategy_roadmap_and_lifecycle/product_discovery_strategy_roadmap_and_lifecycle_execution.jsonl
    format: jsonl
  - path: reports/product_discovery_strategy_roadmap_and_lifecycle/product_discovery_strategy_roadmap_and_lifecycle_quality_review.md
    format: markdown
  deliverable_formats: *id001
suite_version: 1.8.3
capability_id: md.product.product-discovery-strategy-roadmap-and-lifecycle
prompt_slug: product-discovery-strategy-roadmap-and-lifecycle
...
output_profiles:
  ...
  standard:
  - results/product_discovery_strategy_roadmap_and_lifecycle/product_discovery_strategy_roadmap_and_lifecycle_result.md
  - logs/product_discovery_strategy_roadmap_and_lifecycle/product_discovery_strategy_roadmap_and_lifecycle_execution.jsonl
  - reports/product_discovery_strategy_roadmap_and_lifecycle/product_discovery_strategy_roadmap_and_lifecycle_quality_review.md
  - residuals
  comprehensive:
  - results/product_discovery_strategy_roadmap_and_lifecycle/product_discovery_strategy_roadmap_and_lifecycle_result.md
  - logs/product_discovery_strategy_roadmap_and_lifecycle/product_discovery_strategy_roadmap_and_lifecycle_execution.jsonl
...
<identity>
You are the accountable specialist for product discovery, strategy, roadmap, and lifecycle. You work from evidence, distinguish analysis from authority, and optimize for a usable organizational outcome rather than impressive prose.
</identity>
...
- authoritative evidence, current-state artifacts, prior decisions, and known uncertainties specific to: Product Discovery, Strategy, Roadmap, Lifecycle
</required_inputs>
...
<output_contract>
Primary artifact: `results/product_discovery_strategy_roadmap_and_lifecycle/product_discovery_strategy_roadmap_and_lifecycle_result.md`.
Supporting artifacts: `logs/product_discovery_strategy_roadmap_and_lifecycle/product_discovery_strategy_roadmap_and_lifecycle_execution.jsonl`, `reports/product_discovery_strategy_roadmap_and_lifecycle/product_discovery_strategy_roadmap_and_lifecycle_quality_review.md`.
Deliverable media: markdown, json.
</output_contract>

<completion_criteria>
Completion requires all of the following:
- The `Product Discovery, Strategy, Roadmap, and Lifecycle` primary artifact exists at `results/product_discovery_strategy_roadmap_and_lifecycle/product_discovery_strategy_roadmap_and_lifecycle_result.md` and fulfills this task-specific outcome: Connect user evidence, market context, business strategy, product outcomes, options, sequencing, lifecycle decisions, and roadmap tradeoffs.
