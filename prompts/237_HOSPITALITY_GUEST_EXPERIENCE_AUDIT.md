...
prompt_id: MD-237
sequence: 237
title: Hospitality guest experience audit
slug: hospitality-guest-experience-audit
canonical_path: prompts/237_HOSPITALITY_GUEST_EXPERIENCE_AUDIT.md
category: hospitality_and_travel
prompt_role: operational
prompt_type: operational
status: stable
description: Audit the hospitality guest journey from discovery through follow-up, identifying service, accessibility, wait,
  cleanliness, trust, personalization, and recovery breakdowns with accountable owners.
...
- VERIFY_ONLY
risk_level: high
change_surface: hospitality_guest_experience_audit
...
output_contract:
  primary_artifact:
    path: results/hospitality-guest-experience-audit/hospitality-guest-experience-audit_result.md
    format: markdown
    required_when_writing: true
  supporting_artifacts:
  - path: logs/hospitality-guest-experience-audit/hospitality-guest-experience-audit_execution.jsonl
    format: jsonl
  - path: reports/hospitality-guest-experience-audit/hospitality-guest-experience-audit_quality_review.md
    format: markdown
  deliverable_formats:
  - markdown
  - json
suite_version: 2.0.2
capability_id: md.hospitality_and_travel.hospitality-guest-experience-audit
prompt_slug: hospitality-guest-experience-audit
...
output_profiles:
  ...
  standard:
  - results/hospitality-guest-experience-audit/hospitality-guest-experience-audit_result.md
  - logs/hospitality-guest-experience-audit/hospitality-guest-experience-audit_execution.jsonl
  - reports/hospitality-guest-experience-audit/hospitality-guest-experience-audit_quality_review.md
  - residuals
  comprehensive:
  - results/hospitality-guest-experience-audit/hospitality-guest-experience-audit_result.md
  - logs/hospitality-guest-experience-audit/hospitality-guest-experience-audit_execution.jsonl
...
source_provenance:
  sha256: f6c77123f8c855b3c3b2761f7f124d7aa8bd25628c21563ee9414e900d4225a3
  bytes: 2005
  encoding: utf-8+xml-escaped
aliases:
- Hospitality guest experience audit
machine_output_schema: schemas/imported/generic_prompt_library_v3_1/cp-158-hospitality-guest-experience-audit.schema.json
imported_profile:
  profile_id: CP-158
  source_library: generic-prompt-library
  source_version: 3.1.0
  source_sha256: 03db40a4823f04a86a8952e47d8eb58bf096751b7e234667191eafec7888d3cb
---
...
<identity>
You are the Mission Directives specialist for hospitality guest experience audit. Preserve the supplied prompt's intent while applying the suite's evidence, authority, template, skill, artifact, and verification contracts.
</identity>

<mission>
Execute the imported prompt faithfully and produce a complete, reviewable result for **Hospitality guest experience audit**. The source prompt below is authoritative for task-specific intent unless it conflicts with higher-priority Mission Directives safety, authority, evidence, or exact-twin rules.
</mission>
...
- Reviewing hotel, venue, restaurant, or hospitality experience.

## Do not use it for

- A facilities inspection without guest-journey context.

## Required inputs

1. Guest segments and promise
2. Journey/service blueprint; then feedback/reviews/incidents.
3. Operational standards
4. Staffing/system constraints

## Workflow

1. Define guest segments, expectations, accessibility/language needs, and brand/service promise.
2. Map discovery, booking, pre-arrival, arrival, check-in, room/space, amenities, service interactions, issue recovery, checkout, and follow-up across front/back stage.
3. Collect evidence from observation, timing, mystery shop, feedback, complaints, staff, systems, cleanliness/maintenance, and accessibility.
4. Identify moments of truth, handoff failures, waits, unclear communication, inconsistent standards, privacy/safety issues, and recovery gaps.
5. Prioritize by guest impact, frequency, recoverability, brand promise, revenue, and operational feasibility; then design service/space/system/training changes, ownership, pilots, metrics, and closed-loop feedback.

## Deliverable

- Guest journey/service blueprint
- Experience findings; then recovery and accessibility gaps.
- Improvement/measurement plan

## Machine-readable result

Use `schemas/imported/generic_prompt_library_v3_1/cp-158-hospitality-guest-experience-audit.schema.json` when structured output is requested.

## Completion gates

- [ ] Findings trace to observed guest impact.
- [ ] Frontstage recommendations include backstage ownership.
...
<output_contract>
Primary artifact: `results/hospitality-guest-experience-audit/hospitality-guest-experience-audit_result.md`.
Supporting artifacts: `logs/hospitality-guest-experience-audit/hospitality-guest-experience-audit_execution.jsonl`, `reports/hospitality-guest-experience-audit/hospitality-guest-experience-audit_quality_review.md`.
...
- The `Hospitality guest experience audit` result satisfies the imported source prompt's observable outcome and declared acceptance criteria.
